...
按现有证据无法在这三项之间再分解，本报告不宣称哪一项占主导。可以说的是：**第 1 项
与 §5 的观察相容**（提高 critic 质量的旋钮单独用没效果），而它与加权**联合**的效应
从未测过——这是这条线上最便宜的下一步。
...
每步噪声**比基线更小**的条件下，回火臂仍差 1.66 倍。**目前唯一确证有效的展平方式，
仍然只有"给每个信息态一个精确目标"（监督蒸馏 / 精确动力学），而这恰恰是 RL 没有的
东西。**
